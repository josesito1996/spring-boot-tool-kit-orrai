...
/**
 * Adds automatic creation/modification auditing to {@link BaseEntity} for the Spring Boot 2
 * (javax) adapter. The {@code createdAt}/{@code createdBy} columns are populated on insert and the
